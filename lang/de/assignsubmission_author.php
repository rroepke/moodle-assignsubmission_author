...
$string['subject_deleted'] = 'Sie wurden aus einer Autorengruppe im Kurs "{$a->coursename}" entfernt';
$string['message'] = 'Kurs <a href="{$a->courseurl}">{$a->coursename}</a>: <a href="{$a->userurl}">{$a->username}</a> hat eine Einreichung für die Abgabe <a href="{$a->assignmenturl}">{$a->assignmentname}</a> eingereicht und Sie als Co-Autor hinzugefügt.';
$string['message_deleted'] = 'Kurs <a href="{$a->courseurl}">{$a->coursename}</a>: <a href="{$a->userurl}">{$a->username}</a> hat Sie als co-autor in der Abgabe <a href="{$a->assignmenturl}">{$a->assignmentname}</a> entfernt.';
